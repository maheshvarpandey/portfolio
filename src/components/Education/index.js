...
function Education() {
    return (
			<div>
				<div className=" mx-auto relative pb-2 lg:pb-20">
					...
					<div className="border-l-2 mt-10">
						...
						<div className="transform transition cursor-pointer hover:-translate-y-2 ml-10 relative flex items-center px-6 py-4 bg-blue-600 text-white rounded mb-10 flex-col md:flex-row space-y-4 md:space-y-0">
							...
							<div className="flex-auto text-left">
								...
								<h1 className="text-lg font-bold text-left">
									From - Munder Prashad Prashad Intermediate College, Bargadawa,
									Maharajgang, UP ( India )
								</h1>
						...
						{/* Card 2 */}
						<div className="transform transition cursor-pointer hover:-translate-y-2 ml-10 relative flex items-center px-6 py-4 bg-gray-200 text-white rounded mb-10 flex-col md:flex-row space-y-4 md:space-y-0">
							{/* Dot Follwing the Left Vertical Line */}
							<div className="w-5 h-5 bg-gray-200 absolute -left-10 transform -translate-x-2/4 rounded-full z-10 mt-2 md:mt-0" />
							{/* Line that connecting the box with the vertical line */}
							...
							<div className="flex-auto text-left">
								...
								<h1 className="text-lg font-bold text-left">
									From - Ramharsh Intermediate College, Nichlaul, Maharajgang,
									UP ( India )
								</h1>
						...
						<div className="transform transition cursor-pointer hover:-translate-y-2 ml-10 relative flex items-center px-6 py-4 bg-purple-600 text-white rounded mb-10 flex-col md:flex-row space-y-4 md:space-y-0">
							...
							{/* Content that showing in the box */}
							<div className="flex-auto text-left">
								<h1 className="text-2xl font-bold">SimbaQuartz</h1>
								<h1 className="text-lg font-bold text-left">
									Role - Software Engineer, Location - Tangra - Amritsar, Punjab
									( India )
								</h1>
						...
						{/* Card 5 */}
						<div className="transform transition text-white cursor-pointer hover:-translate-y-2 ml-10 relative flex items-center px-6 py-4 bg-gray-600 text-white rounded mb-10 flex-col md:flex-row">
							{/* Dot Follwing the Left Vertical Line */}
							<div className="w-5 h-5 bg-gray-600 absolute -left-10 transform -translate-x-2/4 rounded-full z-10 -mt-2 md:mt-0" />
							{/* Line that connecting the box with the vertical line */}
							<div className="w-10 h-1 bg-gray-300 absolute -left-10 z-0" />
							{/* Content that showing in the box */}
							<div className="flex-auto text-left">
								<h1 className="text-2xl font-bold">Rex Web Soutions</h1>
								<h1 className="text-lg font-bold text-left">
									Role - React Js Developer, Location - Mohali - Chandigarh,
									Punjab ( India )
								</h1>
						...
						<div className="transform transition cursor-pointer hover:-translate-y-2 ml-10 relative flex items-center px-6 py-4 bg-purple-600 text-white rounded mb-10 flex-col md:flex-row space-y-4 md:space-y-0">
							...
							{/* Content that showing in the box */}
							<div className="flex-auto text-left">
								<h1 className="text-2xl font-bold">OIFend</h1>
								<h1 className="text-lg font-bold text-left">
									Role - React JS Deveoper, Location - Telangana, Mahboobnagar (
									India )
								</h1>
								{/* <h3>Experience - ( 2019 - 2021 )</h3> */}
							</div>
						...
						<div className="transform transition cursor-pointer hover:-translate-y-2 ml-10 relative flex items-center px-6 py-4 bg-yellow-600 text-white rounded mb-10 flex-col md:flex-row">
							...
							{/* Content that showing in the box */}
							<div className="flex-auto text-left">
								<h1 className="text-2xl font-bold">Spineor Web Services</h1>
								<h1 className="text-lg font-bold text-left">
									Role - React Js Developer, Location - Mohali - Chandigarh,
									Punjab ( India )
								</h1>
